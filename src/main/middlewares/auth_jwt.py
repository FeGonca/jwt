...
from src.errors.types.http_unauthorized import HttpNotUnauthorizedError
...
def auth_jwt_verify():
    ...
    if not raw_token or not user_id:
        raise HttpNotUnauthorizedError("Invalid Auth informations")
    ...
    raise HttpNotUnauthorizedError("User Unauthorized")